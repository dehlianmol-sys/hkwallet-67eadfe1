...
import { AGENT_SESSION_KEY, COMMISSION_TIERS, referralLink, getAgentById, getAgentStats, type Agent, type AgentStats } from '../../lib/agents';
...
export default function AgentDashboard() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const s = await getAgentStats(a.agentId, a.commissionPercentage);
      if (!active) return;
      setAgent(a);
      setStats(s);
      setLoading(false);
